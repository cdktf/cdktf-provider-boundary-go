...
func (d *jsiiProxy_DataBoundaryUserScopeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataBoundaryUserScopeList) Resolve(context cdktf.IResolveContext) interface{} {
