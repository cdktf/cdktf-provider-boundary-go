...
type TargetConfig struct {
	...
	EnableSessionRecording interface{} `field:"optional" json:"enableSessionRecording" yaml:"enableSessionRecording"`
	...
	StorageBucketId *string `field:"optional" json:"storageBucketId" yaml:"storageBucketId"`
