...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*HostCatalogStatic)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-boundary.hostCatalogStatic.HostCatalogStaticConfig",
		reflect.TypeOf((*HostCatalogStaticConfig)(nil)).Elem(),
	)
}
