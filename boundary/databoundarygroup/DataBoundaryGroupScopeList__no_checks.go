...
func (d *jsiiProxy_DataBoundaryGroupScopeList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DataBoundaryGroupScopeList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
