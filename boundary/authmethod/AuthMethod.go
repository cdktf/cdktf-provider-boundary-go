...
import (
	...
	"github.com/cdktf/cdktf-provider-boundary-go/boundary/v10/authmethod/internal"
...
func (j *jsiiProxy_AuthMethod) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_AuthMethod) MinLoginNameLength() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"minLoginNameLength",
...
func (j *jsiiProxy_AuthMethod) MinLoginNameLengthInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AuthMethod) MinPasswordLength() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"minPasswordLength",
...
func (j *jsiiProxy_AuthMethod) MinPasswordLengthInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AuthMethod) ScopeId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scopeId",
...
func (j *jsiiProxy_AuthMethod) ScopeIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scopeIdInput",
...
func (j *jsiiProxy_AuthMethod) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_AuthMethod) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
func NewAuthMethod(scope constructs.Construct, id *string, config *AuthMethodConfig) AuthMethod {
	...
	_jsii_.Create(
		"@cdktf/provider-boundary.authMethod.AuthMethod",
...
func (j *jsiiProxy_AuthMethod)SetMinLoginNameLength(val *float64) {
...
func (j *jsiiProxy_AuthMethod)SetMinPasswordLength(val *float64) {
...
func (j *jsiiProxy_AuthMethod)SetScopeId(val *string) {
...
func (j *jsiiProxy_AuthMethod)SetType(val *string) {
...
func (a *jsiiProxy_AuthMethod) ResetMinLoginNameLength() {
	_jsii_.InvokeVoid(
		a,
		"resetMinLoginNameLength",
		nil, // no parameters
...
func (a *jsiiProxy_AuthMethod) ResetMinPasswordLength() {
	_jsii_.InvokeVoid(
		a,
		"resetMinPasswordLength",
		nil, // no parameters
...
func (a *jsiiProxy_AuthMethod) ResetName() {
	_jsii_.InvokeVoid(
		a,
		"resetName",
		nil, // no parameters
...
func (a *jsiiProxy_AuthMethod) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AuthMethod) ToHclTerraform() interface{} {
	var returns interface{}
