...
import (
	...
	"github.com/cdktf/cdktf-provider-boundary-go/boundary/v10/user/internal"
...
func (j *jsiiProxy_User) AccountIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"accountIds",
...
func (j *jsiiProxy_User) AccountIdsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"accountIdsInput",
...
func (j *jsiiProxy_User) ScopeId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scopeId",
...
func (j *jsiiProxy_User) ScopeIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scopeIdInput",
...
func NewUser(scope constructs.Construct, id *string, config *UserConfig) User {
	...
	_jsii_.Create(
		"@cdktf/provider-boundary.user.User",
...
func (j *jsiiProxy_User)SetAccountIds(val *[]*string) {
...
func (j *jsiiProxy_User)SetScopeId(val *string) {
...
func (u *jsiiProxy_User) ResetAccountIds() {
	_jsii_.InvokeVoid(
		u,
		"resetAccountIds",
		nil, // no parameters
