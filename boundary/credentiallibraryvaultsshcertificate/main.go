...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-boundary.credentialLibraryVaultSshCertificate.CredentialLibraryVaultSshCertificateConfig",
		reflect.TypeOf((*CredentialLibraryVaultSshCertificateConfig)(nil)).Elem(),
	)
}
