...
import (
	...
	"github.com/cdktf/cdktf-provider-boundary-go/boundary/v10/group/internal"
...
func (j *jsiiProxy_Group) MemberIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"memberIds",
...
func (j *jsiiProxy_Group) MemberIdsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"memberIdsInput",
...
func (j *jsiiProxy_Group) ScopeId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scopeId",
...
func (j *jsiiProxy_Group) ScopeIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scopeIdInput",
...
func NewGroup(scope constructs.Construct, id *string, config *GroupConfig) Group {
	...
	_jsii_.Create(
		"@cdktf/provider-boundary.group.Group",
...
func (j *jsiiProxy_Group)SetMemberIds(val *[]*string) {
	if err := j.validateSetMemberIdsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_Group)SetScopeId(val *string) {
...
func (g *jsiiProxy_Group) ResetMemberIds() {
	_jsii_.InvokeVoid(
		g,
		"resetMemberIds",
		nil, // no parameters
