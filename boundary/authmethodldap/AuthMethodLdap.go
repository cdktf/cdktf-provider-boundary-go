...
import (
	...
	"github.com/cdktf/cdktf-provider-boundary-go/boundary/v10/authmethodldap/internal"
...
func (a *jsiiProxy_AuthMethodLdap) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AuthMethodLdap) ToHclTerraform() interface{} {
	var returns interface{}
