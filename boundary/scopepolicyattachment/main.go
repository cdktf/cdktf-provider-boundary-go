...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ScopePolicyAttachment)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-boundary.scopePolicyAttachment.ScopePolicyAttachmentConfig",
		reflect.TypeOf((*ScopePolicyAttachmentConfig)(nil)).Elem(),
	)
}
