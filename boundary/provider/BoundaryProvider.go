...
import (
	...
	"github.com/cdktf/cdktf-provider-boundary-go/boundary/v10/provider/internal"
...
// Experimental.
func BoundaryProvider_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateBoundaryProvider_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func BoundaryProvider_IsTerraformProvider(x interface{}) *bool {
	_init_.Initialize()

	if err := validateBoundaryProvider_IsTerraformProviderParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (b *jsiiProxy_BoundaryProvider) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (b *jsiiProxy_BoundaryProvider) ToHclTerraform() interface{} {
	var returns interface{}
