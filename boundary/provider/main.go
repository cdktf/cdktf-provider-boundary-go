...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "authMethodLoginName", GoGetter: "AuthMethodLoginName"},
			_jsii_.MemberProperty{JsiiProperty: "authMethodLoginNameInput", GoGetter: "AuthMethodLoginNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "authMethodPassword", GoGetter: "AuthMethodPassword"},
			_jsii_.MemberProperty{JsiiProperty: "authMethodPasswordInput", GoGetter: "AuthMethodPasswordInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAuthMethodLoginName", GoMethod: "ResetAuthMethodLoginName"},
			_jsii_.MemberMethod{JsiiMethod: "resetAuthMethodPassword", GoMethod: "ResetAuthMethodPassword"},
