...
import (
	...
	"github.com/cdktf/cdktf-provider-boundary-go/boundary/v10/hostcatalogplugin/internal"
...
func (j *jsiiProxy_HostCatalogPlugin) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_HostCatalogPlugin)SetCount(val interface{}) {
...
func HostCatalogPlugin_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateHostCatalogPlugin_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (h *jsiiProxy_HostCatalogPlugin) AddMoveTarget(moveTarget *string) {
...
func (h *jsiiProxy_HostCatalogPlugin) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (h *jsiiProxy_HostCatalogPlugin) ToHclTerraform() interface{} {
	var returns interface{}
