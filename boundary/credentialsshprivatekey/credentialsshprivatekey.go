...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CredentialSshPrivateKey)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "privateKeyHmac", GoGetter: "PrivateKeyHmac"},
			...
			_jsii_.MemberProperty{JsiiProperty: "privateKeyPassphraseHmac", GoGetter: "PrivateKeyPassphraseHmac"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-boundary.credentialSshPrivateKey.CredentialSshPrivateKeyConfig",
		reflect.TypeOf((*CredentialSshPrivateKeyConfig)(nil)).Elem(),
	)
}
