...
import (
	...
	"github.com/cdktf/cdktf-provider-boundary-go/boundary/v10/credentialsshprivatekey/internal"
...
func CredentialSshPrivateKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateCredentialSshPrivateKey_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CredentialSshPrivateKey) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CredentialSshPrivateKey) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CredentialSshPrivateKey) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CredentialSshPrivateKey) MoveFromId(id *string) {
...
func (c *jsiiProxy_CredentialSshPrivateKey) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CredentialSshPrivateKey) MoveToId(id *string) {
...
func (c *jsiiProxy_CredentialSshPrivateKey) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CredentialSshPrivateKey) ToHclTerraform() interface{} {
	var returns interface{}
