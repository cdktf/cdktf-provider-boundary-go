...
func (d *jsiiProxy_DataBoundaryAuthMethodScopeList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DataBoundaryAuthMethodScopeList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
